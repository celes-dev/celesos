 ...
 */
void apply_celes_newaccount(apply_context& context) {
...
//   context.require_write_lock( config::eosio_auth_scope );
   ...
   if( !creator.privileged ) {
      EOS_ASSERT( name_str.find( "celes." ) != 0, action_validate_exception,
                  "only privileged accounts can have names that start with 'celes.'" );
   }
...
void apply_celes_setcode(apply_context& context) {
...
void apply_celes_setabi(apply_context& context) {
   auto& db  = context.db;
...
void apply_celes_updateauth(apply_context& context) {
   ...
   EOS_ASSERT( update.permission.to_string().find( "celes." ) != 0, action_validate_exception,
               "Permission names that start with 'celes.' are reserved" );
...
void apply_celes_deleteauth(apply_context& context) {
//   context.require_write_lock( config::eosio_auth_scope );
...
void apply_celes_linkauth(apply_context& context) {
//   context.require_write_lock( config::eosio_auth_scope );
...
void apply_celes_unlinkauth(apply_context& context) {
//   context.require_write_lock( config::eosio_auth_scope );
...
void apply_celes_canceldelay(apply_context& context) {
