...
namespace eosio { namespace chain {
   ...
   {
      OBJECT_CTOR(global_property2_object,(configuration))

      id_type                       id;
      chain_config2                 configuration;
   };
...
CHAINBASE_SET_INDEX_TYPE(eosio::chain::dynamic_global_property_object, eosio::chain::dynamic_global_property_multi_index)
...
FC_REFLECT(eosio::chain::dynamic_global_property_object,
           (global_action_sequence)(diff)(total_dbp_resouresweight)(total_unpaid_resouresweight)
          )