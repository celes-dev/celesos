...
namespace eosiosystem {
    ...
    system_contract::verify(const std::string wood, const uint32_t block_number, const account_name wood_owner_name) {
        ...
        while (itl != itu) {
            ...
            eosio::print("wood1:",wood,"block:",block_number,"voter:",wood_owner_name);
            eosio::print("wood2:",itl->wood,"block:",itl->block_number,"voter:",itl->voter);
    ...
    void system_contract::update_vote(const account_name voter_name, const account_name wood_owner_name,
        ...
        auto bpblockkey = wood_burn_producer_block_stat::bpblockkey(producer_name, block_number);
